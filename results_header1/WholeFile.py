...
// This function calls the LLaMA model with a given prompt and returns the response.
...
// This function processes a file with the given prompt header and saves the result to a new file.
...
// This is the main function of the program. It parses command-line arguments and calls the process_file function for each file in the input directory.
def main():
